...
class HotkeyManager:
    ...
    def _listen(self):
        ...
        # Ctrl+Alt+R 原地润色网页或其他软件中选中的文字
        user32.RegisterHotKey(None, 101, self.MOD_CONTROL | self.MOD_ALT, self.VK_R)
...
class DutyAssistant(tk.Tk):
    ...
    def _build_ui(self):
        ...
        self.status = tk.StringVar(
            value="Alt+1～9 快速回复｜Ctrl+Alt+R 润色选中文字"
        )
    ...
    def _finish_polish_selected(self):
        ...
        self.update()
        self.after(80, self._send_paste)
